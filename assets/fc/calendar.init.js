!function (l) {
	...
	e.prototype.onDrop = function (e, n) {
		var t = e.data("eventObject"), a = e.attr("data-class"), o = l.extend({}, t);
		...
		var a = this, o = l("<form></form>");
		o.append("<label>Change event name</label>"), o.append("<div class='input-group'><input class='form-control' type=text value='" + n.title + "' /><span class='input-group-btn'><button type='submit' class='btn btn-success waves-effect waves-light'><i class='fa fa-check'></i> Save</button></span></div>"), a.$modal.modal({backdrop: "static"}), a.$modal.find(".delete-event").show().end().find(".save-event").hide().end().find(".modal-body").empty().prepend(o).end().find(".delete-event").unbind("click").click(function () {
		...
		this.enableDrag();
		var
			e = new Date, n = (e.getDate(), e.getMonth(), e.getFullYear(), new Date(l.now())),

        ...
        <section class="content">
                ...
                <div class="col-lg-1">
                    <div class="dropdown mt-4">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="nextSlide()"><i class='fa fa-check'></i> Mark this Status as Complete</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)" data-bs-toggle='modal' data-bs-target='#addStage'><i class='fa fa-plus'></i> Add New Stage</a></li>
                            ...
                            <li><a class="dropdown-item" href="#"><i class='fa fa-trash'></i> Delete Lead</a></li>
            ...
            <div class="stepSection">
                ...
                <ol id='list2' class="arrow-steps clearfix">
                    ...
                    <li class="step current"> <span> Linked</span> </li>
                    <li class="step"> <span> Audit</span> </li>
                    <li class="step"> <span> Presentation</span> </li>
                    <li class="step"> <span> Follow Up</span> </li>
                    <li class="step"> <span> Contract Sent</span> </li>
                    <li class="step"> <span> Converted</span> </li>

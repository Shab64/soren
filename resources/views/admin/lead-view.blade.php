                            ...
                            <div class="col-lg-1 drdiv">
                                <div class="dropdown mt-4">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php } ?>
{{--                                        <li><a class="dropdown-item" href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('moveToForm').action = '<?= Route('admin.moveTo.status', ['Compilance']) ?>'; document.getElementById('moveToForm').submit();"><i class='fa fa-arrow-right'></i> Move to Compliance</a></li>--}}
{{--                                        <li><a class="dropdown-item" href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('moveToForm').action = '<?= Route('admin.moveTo.status', ['Lost']) ?>'; document.getElementById('moveToForm').submit();"><i class='fa fa-arrow-right'></i> Move to Lost</a></li>--}}
                                        ...
                                        <li><a class="dropdown-item" href="javascript:void(0)" onclick="delete_('<?= route('admin.deleteLead.id', [$lead_id[0]['id']]) ?>')"><i class='fa fa-trash'></i> Delete Lead</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    ...
                                    <ul class="tasklist">
                                        ...
                                        @endforeach
                                        @else
                                            <p style="color: gray">{{'No task found'}}</p>
                                        @endif
                                    </ul>
                                </div>
                                ...
                                <div class="tab-pane fade" id="pills-event" role="tabpanel" aria-labelledby="pills-event-tab">
                                    ...
                                    @else
                                        <p style="color: gray">{{'No event found'}}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="addTask" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{url('admin/lead/addTask/'.$lead_id[0]['id'])}}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
...
<div class="modal fade" id="addNote" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('admin/lead/update/'.Request::segment(4))}}">
                @csrf
                <div class="modal-body">
...
<div class="modal fade" id="changeStage" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ Route('admin.updateTempStages') }}">
                @csrf
...
<div class="modal fade" id="editLead" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{url('admin/lead/update/'.$lead_id[0]['id'])}}" class="row" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="formTitle">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="f_date" value="{{(!empty($lead_id[0]['f_date'])) ? $lead_id[0]['f_date'] : "" }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Follow Up Time</label>
                                        <input type="time" class="form-control" name="time" value="{{(!empty($lead_id[0]['time'])) ? $lead_id[0]['time'] : "" }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Phone</label>
                                <input type="number" class="form-control" name="phone" value="{{(!empty($lead_id[0]['phone'])) ? $lead_id[0]['phone'] : "" }}">
                            </div>
                            <div class="form-group">
                                <label for="">Alternate Phone</label>
                                <input type="number" class="form-control" name="a_phone" value="{{(!empty($lead_id[0]['a_phone'])) ? $lead_id[0]['a_phone'] : "" }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="website" value="{{(!empty($lead_id[0]['website'])) ? $lead_id[0]['website'] : "" }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="gate_keeper_name" value="{{(!empty($lead_id[0]['gate_keeper_name'])) ? $lead_id[0]['gate_keeper_name'] : "" }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="other" id="" cols="30" rows="10" class="form-control">{{(!empty($lead_id[0]['other'])) ? $lead_id[0]['other'] : "" }}</textarea>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="marketing_partner" value="{{(!empty($lead_id[0]['marketing_partner'])) ? $lead_id[0]['marketing_partner'] : "" }}">
                            </div>
                            <div class="form-group">
                                <label for="">CD</label>
                                <input type="text" class="form-control" name="cd" value="{{(!empty($lead_id[0]['cd'])) ? $lead_id[0]['cd'] : "" }}">
                            </div>
                            <div class="form-group">
                                <label for="">Ad Spend</label>
                                <input type="number" class="form-control" name="ad_spend" value="{{(!empty($lead_id[0]['ad_spend'])) ? $lead_id[0]['ad_spend'] : "" }}">
                            </div>
...
<script>
    ...
    const nextSlide2 = (leadID) => {
        ...
        let _token = '{{ csrf_token() }}';
        $.ajax({
            url: "{{ Route('admin.changeInnerLead') }}",
            type: "post",
            data: {
                _token,
                leadID
    ...
    const nextSlide3 = (leadID) => {
        ...
        let _token = '{{ csrf_token() }}';
        $.ajax({
            url: "{{ Route('admin.changeUpsellStage') }}",
            type: "post",
            data: {
                _token,
                leadID

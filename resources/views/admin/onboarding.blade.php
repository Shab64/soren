                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="myTable2" class="table table-bordered ">
                                    ...
                                    <tbody>
                                        <?php if (!empty($intakeandonboarding_leads)) {
                                            foreach ($intakeandonboarding_leads as $k => $lead) { ?>
                                                <tr>
                                                    <td>{{ $k+1 }}</td>
                                                    <td>{{ $lead['company'] }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{url('admin/view/lead-view/'.$lead['id'])}}" class="btn btn-primary btn-sm" title="view details"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                </tr>
                                        <?php }
                                        } ?>
